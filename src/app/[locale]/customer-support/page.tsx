        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
              ...
              {contactMethods.map((method, index) => (
                <Card key={index} className="text-center hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    ...
                    <Link href={method.link} className="text-red-600 hover:underline text-sm font-medium">
                      {method.details}
                    </Link>
                  </CardContent>
                </Card>
          ...
          <section className="text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button asChild className="bg-red-600 hover:bg-red-700 text-white py-3 px-8 text-lg">
                <Link href="/faq">Visit FAQ</Link>
              </Button>
              <Button
                asChild
                variant="outline"
                className="bg-transparent border-red-600 text-red-600 hover:bg-red-50 py-3 px-8 text-lg"
              >

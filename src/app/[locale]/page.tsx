            ...
            <div className="text-center md:w-2/3 lg:w-1/2 xl:w-1/3 md:text-left">
                ...
                <form action="#" method="POST" className="mt-8 lg:mt-12">
                    <div className="flex flex-col items-center sm:flex-row ">
                        <button type="submit" className="inline-flex items-center justify-center  w-[200px] px-4 py-4 mt-4 font-semibold text-white transition-all duration-200 bg-pink-600 border border-transparent rounded-md sm:mt-0  sm:w-auto hover:bg-pink-700 focus:bg-pink-700">
                        Shop Sweets
                        </button>
                    </div>
                </form>
              ...
              <div className="absolute -bottom-10 -left-16">
                <div className="bg-yellow-300">
                  <div className="px-8 py-10">
                    <span className="block text-4xl font-bold text-black lg:text-5xl"> 100% </span>
                    <span className="block mt-2 text-base leading-tight text-black"> Fresh & Delicious<br />Everyday </span>
                  </div>
                </div>
              </div>
            </div>

            ...
            <div className="text-center md:w-2/3 lg:w-1/2 xl:w-1/3 md:text-left flex flex-col items-center justify-center h-full sm:block sm:h-auto">
                ...
                <form action="#" method="POST" className="mt-8 lg:mt-12">
                    <div className="flex flex-col items-center sm:flex-row ">
                        <button type="submit" className="cursor-pointer inline-flex items-center justify-center  w-[200px] px-4 py-4 mt-4 font-semibold text-white transition-all duration-200 bg-pink-600 border border-transparent rounded-md sm:mt-0  sm:w-auto hover:bg-pink-700 focus:bg-pink-700">
                        Shop Sweets
                        </button>
                    </div>
                </form>
